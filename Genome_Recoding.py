...
Disclaimer: The author will not be held accountable for any problems or issues 
caused as the result of use of this program
'''
#==============================================================================
# Input
#==============================================================================
Input_GenBank_File = 'MDS42_20kbv11_marked.gb'
Output_GenBank_File = 'recoded_genome.gb'

recoding_scheme = [{'target': 'TAG', 'recode': 'TAA'},
                   {'target': 'TCG', 'recode': 'AGT'},
                   {'target': 'TCA', 'recode': 'AGT'}]

synthetic_insertion_size= 200
